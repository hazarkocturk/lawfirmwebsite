...
const Banner = () => {
  return (
    <section className='lg:h-full lg:max-h-800 bg-gradient-to-t from-[#f8f3ec] to-[#e0c8ac]'>
      <Header />
      <div className='container mx-auto h-full lg:flex'>
        <div className='text-center mx-auto h-full lg:text-left'>
          <h1 className='font-primary font-black text-6xl lg:text-7xl text-primary mb-4 mt-[70px] leading-tight lg:leading-[90px]'>
